 ...
 */
final class Version20240322130010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offre ADD etat_offre VARCHAR(255) NOT NULL, ADD email VARCHAR(255) NOT NULL, DROP etatOffre, CHANGE nom nom VARCHAR(255) NOT NULL, CHANGE id_coach coach_id INT NOT NULL');
